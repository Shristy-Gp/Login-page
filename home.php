...
<body>
    ...
    <div class="nav">
        ...
        <div class="nav-right">
                ...
                <div class="user">
                    ...
                    <div class="user-info">
                        <span class="user-name">Mr. Abcdef</span>
                        <span class="user-email">abcdef@email.com</span>
                    </div>
    ...
    <div class="main">
        ...
        <div class="main-content">
                <!-- --------------------profile-------------- -->
            <div class="admin-profile hidden">
                <h2>My Profile</h2>
                <div class="profile-card">
                    ...
                    <div class="profile-info">
                        <div class="profile-left">
                            <img src="https://via.placeholder.com/120" class="profile-img" id="profileImage">
                            <!-- <input type="file" id="imageUpload" accept="image/*" hidden>
                            <button type="button" class="change-img-btn hidden">Change Photo</button> -->
                            <div><h3 id="profile-name">User Name</h3><h3 id="profile-email">User email.com</h3></div>
                        </div>      
                        <div class="profile-right">
                            <div class="account-information">
                                <h3>Account Information</h3>
                                <div class="one"><div class="aa"><b>Username :</b></div><input type="text" id="acc-user-name" disabled></div>
                                <div class="one"><div class="aa"><b>Email :</b></div><input type="email" id="acc-user-email" disabled></div>
                                <div class="one"><div class="aa"><b>Phone :</b></div><input type="number" id="acc-user-ph" disabled></div>
                            </div>
                            <div class="personal-detail">
                                <h3>Personal Details</h3>
                                <div class="one"><div class="aa"><b>Full Name :</b></div><input type="text" id="acc-user-fullname" disabled></div>
                                <div class="one"><div class="aa"><b>Date of Birth :</b></div><input type="date" id="acc-user-dob" disabled></div>
                                <div class="one"><div class="aa"><b>Gender :</b></div><input type="text" id="acc-user-gender" disabled></div>
                                <div class="one"><div class="aa"><b>Location :</b></div><input type="text" id="acc-user-loc" disabled></div>
                                <div class="one"><div class="aa"><b>City :</b></div><input type="text" id="acc-user-city" disabled></div>
                                <div class="one"><div class="aa"><b>State :</b></div><input type="text" id="acc-user-state" disabled></div>
                                <div class="one"><div class="aa"><b>Pincode :</b></div><input type="number" id="acc-user-pin" disabled></div>
                            </div>
                        </div>  
                    </div>
                </div>
...
<!------------------------ dashboard -------------------->
            <div class="dashboard ">
                ...
                <div class="card">
                    ...
                    <div class="low-stock"  onclick="showLowStock()">
                        <p>Stock alert</p>
                        <hr>
                        <h3>0</h3>
                    </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>5</td>
                            <td>soon</td>
                            <td><button class="edit" onclick="editMedicine(this)">edit</button><button class="delete" onclick="deleteMedicine(this)">delete</button></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="inventory hidden">
                ...
                <div class="card1">
                    <div onclick="openSection('history')"><p>Stock history</p></div>
                    <div onclick="openSection('purchase')"><p>Stock purchase</p></div>
                </div>
                <div class="stock-history hidden" id="stockHistoryBox">
                    <table>
                        <thead>
                            <tr>
                                <th scope="col">med_id</th>
                ...
                <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
                <div class="stock-purchase hidden" id="stockPurchaseBox">
                    ...
                    <div class="supplier-form">
                        <div>
                            ...
                            <select id="supplierId" onchange="fillSupplierName()"></select>
                        </div>
                    ...
                    <div style="margin:10px 0;">
                        <label><b>GST % :</b></label>
                        <input type="number" id="gstGlobal" placeholder="Enter GST %" style="width:120px;">
                    </div>

                    <button id="addRowPurchase">+ Add Row</button>
                    ...
                    <div class="payment-summary">
                        ...
                        <div class="row">
                            <div><span>Subtotal :</span><span id="subTotal">0.00 rs.</span></div>
                            <div><span>GST amt :</span><span id="gstTotal">0.00 rs.</span></div>
                            <hr>
                            <div class="grandtot"><span>Grand Total :</span><span id="grandTotal">0.00 rs.</span></div>
                        </div>
                    </div>

                    <div class="paybutton">
                        <button id="savePurchase">Save</button>
                        <button id="clearPurchase">Clear</button>
                        <button id="payPurchase">Pay Now</button>
                    </div>
                    ...
                    <form action="" method="post">
                        <div class="rows">
                            <div class="field">
                                ...
                                <input type="number" name="med_id" id="med_id" required>    
                            </div>
                            <div class="field">
                        ...
                        <div class="rows">
                            <div class="field">
                                <label for="cost_price">Cost rate</label>
                                <input type="number" id="cost_price" required>
                            </div>
                            <div class="field">
                                <label for="sell_price">Sell rate</label>
                                <input type="number" id="sell_price" required>
                            </div>
                        </div>                                                    
                        <div class="buttons">
             ...
             <div class="billing hidden">
                ...
                <div class="billing-box">
                    <div class="customer-form">
                        <div><label>Customer name :</label><input type="text" id="cname"></div>
                        <div><label>Phone Number :</label><input type="text" id="cphone"></div>
                        <div><label>Billing Date :</label><input type="date" id="cdate"></div>
                    </div>
                    <div class="medicine-box">
                        <table class="medicine-table">
                            ...
                            <tr>
                                <td><select class="medId" onchange="fillMedDetail(this)"></td>
                                <td><input id="comname" type="text"></td>
                                <td><input id="medname" type="text"></td>
                                <td><input id="cat" type="text"></td>
                                <td><input type="number" class="qty"></td>
                                <td><input type="number" class="price"></td>
                                <td><input type="number" class="GST"></td>
                                <td class="total">0</td>
                                <td><button onclick="removeRow(this)" class="remove">Remove</button></td>    
                            </tr>
                        </table>
                    </div>
                    <div class="discount-box">
                        ...
                        <button id="calbil">calculate Bill</button>
                    </div>
                    <div class="payment-summary">
                        <h3>Payment Summary</h3>
                        <div class="row">
            ...
            <div class="supplier hidden">
                <div class="head">
                    ...
                    <div class="button"><button class="add-supplier-btn">+ Add supplier</button></div>
                </div>               
                <table>
                    <thead>
                        <tr>
                ...
                <div class="add-supplier-form hidden">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="rows">
                            <div class="field">
                                ...
                                <input type="number" id="supplier-id" placeholder="Enter medicine id.." required>
                            </div>
                            <div class="field">
                                <label for="supplier-name">Supplier</label>
                                <input type="text" id="supplier-name" placeholder="Enter name here.." required>
                            </div>                            
                        </div>
                        <div class="rows">
                            <div class="field">
                                <label for="s-Contact">Contact</label>
                                <input type="tel" id="s-contact" placeholder="e.g. 1112223334" required>
                            </div>
                            <div class="field">
                                <label for="s-email">Email</label>
                                <input type="email" id="s-email" placeholder="e.g. abc@def.com">
                            </div>                        
                        </div>
                    <div class="rows">
                        <div class="field">
                            <label for="s-pincode">Pincode</label>
                            <input type="number" id="s-pincode" placeholder="------" required>
                        </div>
                        <div class="field">
                            <label for="s-address">Address</label>
                            <input type="text" id="s-address" placeholder="Are they live in your city?" required>    
                        </div>                        
                    </div>
                    <div class="buttons">
                            <button type="button" class="s-cancel">Cancel</button>
                            <button type="submit" class="s-ok">OK</button>
                    </div>
                    </form>
                    ...
                    <div class="section1">
                        ...
                        <div>
                             <div class="setting-section">
                                <h3>App Settings</h3>  
                                <div class="chkbx">
                                    <label class="right"><input type="checkbox">Dark mode</label>
